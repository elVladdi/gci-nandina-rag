...
class SummaryManifestLedgerOrchestrationV05Tests(unittest.TestCase):
    ...
    def manifest(self):
        ...
        environment = {
            **{key: gate.TESTED_ENVIRONMENT[key] for key in ("python_version", "python_implementation", "architecture", "platform_system", "machine", "executable_sha256")},
            ...
            "historical_vector_replay": {
                "status": "PASS", "required": True, "sample_count": 21,
                "cosine_min": 1.0, "max_absolute_difference": 0.0, "tolerance": 1e-6,
    ...
    def test_manifest_rejects_nan_missing_key_order_and_v04_root(self) -> None:
        ...
        replay_optional = self.manifest(); replay_optional["environment_fingerprint"]["historical_vector_replay"]["required"] = False; variants.append(replay_optional)
        replay_wrong_count = self.manifest(); replay_wrong_count["environment_fingerprint"]["historical_vector_replay"]["sample_count"] = 20; variants.append(replay_wrong_count)
