...
class SummaryManifestLedgerOrchestrationV05Tests(unittest.TestCase):
    ...
    def manifest(self):
        return {"artifact_id": "m", "status": "PASS", "authorization_provenance": {"status": "PASS"}, "pipeline_steps": list(gate.PIPELINE_STEPS), "future_roots": list(gate.FUTURE_ROOTS), "results": {}}
