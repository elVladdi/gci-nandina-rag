# Group 2B reproducibility and traceability readiness v0.2
...
This candidate supersedes rejected readiness candidate
`26b64db898b96ef1225d6f238bedc44ffaa87823` solely for
`EXP11A_DOCUMENTARY_SEMANTIC_CORRECTION`.
...
| EXP11A | H100/compositions -> independent complete-DAM conditions; H50 paired D1/D2 stratification; nesting not required / structurally infeasible -> gated 31 runs -> metrics/case-level -> freeze | `COMPLETE_WITH_DECLARED_LIMITATION` |
...
- EXP11A preserves H25 as 10 runs with seeds `20261001..20261010`; H50 as
  10 runs from paired seeds `20261001..20261005`, split into 5 D1 and 5 D2;
  H75 as 10 runs with seeds `20261001..20261010`; and H100 as the frozen
  reference, for which seed is not applicable.
