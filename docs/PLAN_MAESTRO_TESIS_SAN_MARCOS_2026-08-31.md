...
| 5. Presentación de resultados | **IN_PROGRESS — G5-F01=CLOSED/APPROVED/INTEGRATED_TO_MAIN; G5-F02=ELIGIBLE/NOT_AUTHORIZED/NOT_EXECUTED** |
...
FICHAS_G3_G8_SNAPSHOT_COMMIT = 86211dee649f2676f4cb3747ba116da147a7d37f
FICHAS_G3_G8_ROOT = docs/fichas/grupos_3_8/
FICHAS_G3_G8_COUNT = 19
FICHAS_G3_G8_STATUS = GROUP3_CLOSED / GROUP4_CLOSED / G5-F01_CLOSED_APPROVED_INTEGRATED / G5-F02_ELIGIBLE_NOT_AUTHORIZED / REMAINING_FICHAS_NOT_AUTHORIZED
...
El cierre aprobado de G3-F02 queda gobernado por:
...
El cierre aprobado de G3-F03 queda gobernado por:
...
`STATISTICAL_INFERENCE_EXECUTED = true` describe exclusivamente los intervalos
bootstrap autorizados en G3-F03; no equivale a una decisión de HE2 o HE5.

El cierre aprobado de G3-F04 y Grupo 3 queda gobernado por:
...
El cierre aprobado de G4-F01 queda gobernado por:
...
EXP11A_INTERPRETATION = JOINT_SIZE_COMPOSITION_SENSITIVITY / NO_ISOLATED_CAUSAL_SIZE_EFFECT
EXP11B_INTERPRETATION = DESCRIPTIVE_SENSITIVITY / NO_SEED_SUPERPOPULATION_INFERENCE
CURRENT_0B05C_STATE = ATTEMPT06_CORRECTED_RESULTS
0B05C_GLOBAL_ZERO_IMPACT_CLAIM = PROHIBITED
EXP12_DIVERSITY_EFFECT_ESTIMABLE = false
EXP12 = NOT_ESTIMABLE / CLOSED_WITHOUT_RETRIEVAL
G3C010_HE5_POSITIVE_EVIDENCE_ROLE = NONE
G3C010_HE5_NEGATIVE_EVIDENCE_ROLE = NONE
...
El cierre aprobado de G4-F02 queda gobernado por:
...
EXP11A_INTERPRETATION = JOINT_SIZE_COMPOSITION_SENSITIVITY / NO_ISOLATED_OR_MONOTONIC_CAUSAL_SIZE_EFFECT
EXP11B_INTERPRETATION = DESCRIPTIVE_H150_H200_TEN_OBSERVED_SEED_PAIRS / NO_SEED_SUPERPOPULATION_INFERENCE / NO_10_X_1056_INDEPENDENCE
CURRENT_0B05C_STATE = ATTEMPT06_CORRECTED / EV03_ZERO_AGGREGATE / EV04_TINY_NONZERO_MRR_DECREASE / D1A_NONZERO_CHANGE
0B05C_GLOBAL_ZERO_IMPACT_CLAIM = PROHIBITED
EXP12 = CLOSED_WITHOUT_RETRIEVAL / PLANNING_PRECONDITION_FAILED_UNDER_FROZEN_SEARCH / DIVERSITY_EFFECT_NOT_ESTIMABLE
EXP12_GLOBAL_MATHEMATICAL_INFEASIBILITY_CLAIM = PROHIBITED
EXP12_UNEXECUTED_SEED_CHARACTERIZATION = PROHIBITED
EXP12_HE5_POSITIVE_EVIDENCE_ROLE = NONE
EXP12_HE5_NEGATIVE_EVIDENCE_ROLE = NONE
GROUP2B_NONBLOCKING_LIMITATION_COUNT = 11
GROUP2B_PERFECT_REPRODUCIBILITY_CLAIM = PROHIBITED
HASH_BOUND_LOCAL_ONLY_MEANS_MISSING_OR_INVALID = false
DECLARED_NOT_RECOVERABLE_MEANS_EXPERIMENTAL_ERROR = false
HISTORICAL_RETRIEVAL_SUPERIORITY_EQUALS_GLOBAL_RAG_ACCURACY = false
NORMATIVE_EVIDENCE_EQUALS_BINDING_LEGAL_CORRECTNESS = false
AUDITABLE_EXPLANATION_EQUALS_CLASSIFICATION_OR_LEGAL_CORRECTNESS = false
...
El cierre aprobado de G4-F03 y Grupo 4 queda gobernado por:
...
G4_F02 = CLOSED / APPROVED / INTEGRATED_TO_MAIN
G4_F03 = CLOSED / APPROVED / INTEGRATED_TO_MAIN
G4_F03_INTEGRATION_COMMIT = 38e22c19a0eb0d344e7675761a88d7968091eead
...
NORMATIVE_EVIDENCE_EQUALS_BINDING_LEGAL_CORRECTNESS = false
AUDITABLE_EXPLANATION_EQUALS_CLASSIFICATION_OR_LEGAL_CORRECTNESS = false
CROSS_STUDY_NUMERIC_SUPERIORITY_CLAIM = PROHIBITED
SOTA_CLAIM = PROHIBITED
NOVELTY_REDECISION = PROHIBITED
GROUP2B_NONBLOCKING_LIMITATION_COUNT = 11
```

El cierre aprobado de G5-F01 queda gobernado por:
...
### 2026-09-19 — Cierre de G3-F02 tras auditoría externa

- El registro maestro de métricas y poblaciones de G3-F02 recibió auditoría
  externa `PASS` y quedó integrado mediante fast-forward puro en
  `main = origin/main = adf70d6eb880c567d6efa0f27b5c79259b8db2a6`.
- La integración preservó byte-idénticos los tres artefactos auditados, con
  548 filas y 16 familias de evidencia; no recalculó métricas ni ejecutó
  inferencia.
- `GROUP3 = IN_PROGRESS`; `G3_F02 = CLOSED / APPROVED /
  INTEGRATED_TO_MAIN`; `NEXT_ELIGIBLE_FICHA = G3-F03`.
- `G3_F03 = ELIGIBLE / NOT_AUTHORIZED / NOT_EXECUTED`.
- `STATISTICAL_INFERENCE_EXECUTED = false`, `HE2_DECIDED = false`,
  `HE5_DECIDED = false` y `EXP12_RETRIEVAL = NOT_AUTHORIZED / NOT_EXECUTED`.

### 2026-09-19 — Cierre de G3-F03 tras auditoría externa

- Los resultados inferenciales de G3-F03 recibieron auditoría externa `PASS`
  y quedaron integrados mediante fast-forward puro en
  `main = origin/main = 7d09f692da23367d3aba941db1febdca2baa8917`.
- La integración preservó byte-idénticos los cinco artefactos auditados y no
  recalculó bootstrap, intervalos, métricas ni p-values.
- G3-F03 materializó 16 resultados inferenciales primarios (15 HE2_A y 1
  HE2_B) y 3 Top-50 suplementarios bajo el procedimiento prospectivo.
- `STATISTICAL_INFERENCE_EXECUTED = true` se limita a esa ejecución de
  intervalos cluster-aware; `HE2_DECIDED = false` y `HE5_DECIDED = false`.
- `GROUP3 = IN_PROGRESS`; `G3_F03 = CLOSED / APPROVED /
  INTEGRATED_TO_MAIN`; `G3_F04 = ELIGIBLE / NOT_AUTHORIZED / NOT_EXECUTED`.
- `EXP12_RETRIEVAL = NOT_AUTHORIZED / NOT_EXECUTED`.

### 2026-09-19 — Cierre canónico de Grupo 3 tras auditoría externa de G3-F04

- El candidato G3-F04 recibió auditoría externa `PASS` y quedó integrado por
  fast-forward puro en `main = origin/main =
  09278a10063a1e175ee2991b60f7649dd2ee40f4`.
- La integración preservó byte-idénticos los tres artefactos auditados; G3-F04
  no recalculó inferencia, intervalos, métricas ni p-values.
- `HE2 = SUPPORTED`: HE2_A y el contraste jerárquico HE2_B quedaron apoyados
  por evidencia primaria, con Phase E direccionalmente consistente en plano
  descriptivo.
- `HE5 = INCONCLUSIVE`: descripción no estimable, jerarquía descriptiva y
  ausencia de umbral congelado de insuficiencia impiden una conclusión más
  fuerte; la limitación de validez interna permanece documentada.
- `GROUP3 = CLOSED / APPROVED`; G3-F01, G3-F02, G3-F03 y G3-F04 están
  `CLOSED / APPROVED / INTEGRATED_TO_MAIN`.
- `G4_F01 = ELIGIBLE / NOT_AUTHORIZED / NOT_EXECUTED` y
  `EXP12_RETRIEVAL = NOT_AUTHORIZED / NOT_EXECUTED`.

### 2026-09-19 — Cierre de G4-F01 tras auditoría externa

- La matriz resultado-claim-evidencia de G4-F01 recibió auditoría externa
  `PASS` y quedó integrada por fast-forward puro en `main = origin/main =
  9f549ebdf940f9d806d5088697394d0c927f9fdc`.
- La integración preservó byte-idénticos los dos artefactos auditados, con 18
  claims controlados, cero claims sobrefortalecidos y sin nueva inferencia ni
  recálculo de métricas.
- `HE2 = SUPPORTED` y `HE5 = INCONCLUSIVE` permanecen sin cambios.
- EXP11A sigue siendo sensibilidad conjunta tamaño/composición; EXP11B sigue
  siendo descriptivo; Attempt06 corregido sigue siendo el estado vigente de
  0B-05C; EXP12 permanece no estimable y cerrado sin retrieval.
- La superioridad del retrieval histórico no equivale a exactitud global del
  RAG; la evidencia normativa no equivale a corrección jurídica vinculante; y
  una explicación auditable no equivale a clasificación o corrección legal.
- `GROUP4 = IN_PROGRESS`; `G4_F01 = CLOSED / APPROVED /
  INTEGRATED_TO_MAIN`; `G4_F02 = ELIGIBLE / NOT_AUTHORIZED / NOT_EXECUTED`.

### 2026-09-20 — Cierre de G4-F02 tras auditoria externa

- La sintesis interpretativa y el registro de limitaciones de G4-F02 recibieron
  auditoria externa `PASS` y quedaron integrados por fast-forward puro en
  `main = origin/main = 203770565e1a68c30ab3f27b912fc0fd971e4e8f`.
- La integracion preservo byte-identicos los dos artefactos auditados, las 11
  limitaciones no bloqueantes de Grupo 2B y la separacion entre hallazgo,
  explicacion plausible y especulacion no soportada.
- `HE2 = SUPPORTED` y `HE5 = INCONCLUSIVE` permanecen sin redecision; no se
  recalcularon metricas, inferencia, intervalos ni p-values.
- EXP11A conserva el alcance conjunto tamano/composicion; EXP11B permanece
  descriptivo para los diez pares H150/H200 observados; Attempt06 corregido
  sigue vigente; EXP12 permanece cerrado sin retrieval y no estimable bajo la
  busqueda congelada.
- Grupo 2B conserva 11 limitaciones no bloqueantes y no se declara
  reproducibilidad perfecta. `HASH_BOUND_LOCAL_ONLY` no equivale a ausente o
  invalido; `DECLARED_NOT_RECOVERABLE` no equivale a error experimental.
- La superioridad de retrieval historico no equivale a exactitud global del
  RAG; la evidencia normativa no equivale a correccion juridica vinculante; y
  una explicacion auditable no equivale a clasificacion o correccion legal.
- `GROUP4 = IN_PROGRESS`; `G4_F02 = CLOSED / APPROVED /
  INTEGRATED_TO_MAIN`; `G4_F03 = ELIGIBLE / NOT_AUTHORIZED / NOT_EXECUTED`.

### 2026-09-20 — Cierre de G4-F03 y Grupo 4 tras reauditoria externa

- El candidato corregido G4-F03 v02 recibio reauditoria externa `PASS` y fue
  integrado por fast-forward puro en `main = origin/main =
  38e22c19a0eb0d344e7675761a88d7968091eead`.
- Los artefactos auditados se preservaron sin regeneracion: matriz de contraste
  con 11 registros, 8 puntos de discusion autorizados y 14 prohibidos.
- `HE2 = SUPPORTED` y `HE5 = INCONCLUSIVE` permanecen sin redecision; no se
  recalcularon metricas, inferencia, intervalos ni p-values.
- EXP11A permanece no causal; EXP11B descriptivo sin inferencia a una
  superpoblacion de seeds; Attempt06 corregido sigue siendo el estado vigente
  de 0B-05C; y EXP12 permanece cerrado sin retrieval y con efecto de diversidad
  no estimable.
- La superioridad interna del retrieval historico no equivale a exactitud
  global del RAG; la evidencia normativa no equivale a correccion juridica
  vinculante; una explicacion auditable no valida la clasificacion; no se
  declara superioridad numerica cross-study, SOTA ni novelty.
- Las 11 limitaciones no bloqueantes canonicas de Grupo 2B permanecen vigentes.
- `GROUP4 = CLOSED / APPROVED`; `G4_F03 = CLOSED / APPROVED /
  INTEGRATED_TO_MAIN`; `GROUP5 = NOT_STARTED`; `G5_F01 = ELIGIBLE /
  NOT_AUTHORIZED / NOT_EXECUTED`.

### 2026-09-21 — Cierre de G5-F01 tras reauditoria externa

- El candidato corregido G5-F01 v02 recibio reauditoria externa `PASS` y fue
  integrado por fast-forward puro en `main = origin/main =
  d5729887f47c36d8cf42d87090c40f9668e5ae84`.
- Los dos artefactos auditados se preservaron sin regeneracion: plan de
  presentacion y registro de 16 estructuras, con 16 familias G3 y 18 claims G4
  mapeados.
- G5-MAIN-01 mantiene separados los valores absolutos por brazo, el contraste
  pareado historico menos comparador y el CI de 99% ligado a ese mismo
  contraste; no se calcularon nuevos intervalos.
- `HE2 = SUPPORTED` y `HE5 = INCONCLUSIVE` permanecen sin redecision; no se
  recalcularon metricas, inferencia ni p-values, y EXP12 permanece cerrado sin
  retrieval y no estimable.
