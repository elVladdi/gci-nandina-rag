...
| 2. Reproducibilidad y trazabilidad | **CLOSED / APPROVED_WITH_NONBLOCKING_LIMITATIONS — main = origin/main = fbd321d817d22fef78417064e0d5bc8df37165ca; GROUP2B_READINESS_V02=AUDITED/APPROVED/INTEGRATED; BLOCKING_GAP_COUNT=0; NONBLOCKING_LIMITATION_COUNT=11; HISTORICAL_ONLY_COUNT=5; ENVIRONMENT_REPRODUCIBILITY=COMPLETE_WITH_DECLARED_LIMITATION; CLEAN_CHECKOUT_REPRODUCIBILITY=COMPLETE_WITH_DECLARED_LIMITATION; SCIENTIFIC_REEXECUTION_REQUIRED=false; RESULTS_RECOMPUTATION_REQUIRED=false. Las limitaciones `DECLARED_NOT_RECOVERABLE` y los assets `HASH_BOUND_LOCAL_ONLY` permanecen explícitos; este cierre no declara reproducibilidad perfecta. EXP12_ORIGINAL_FROZEN_DESIGN=CLOSED; EXP12_DISPOSITION=CLOSED_WITHOUT_RETRIEVAL/PLANNING_PRECONDITION_FAILED_UNDER_FROZEN_SEARCH; EXP12_DIVERSITY_EFFECT_ESTIMABLE=false; EXP12_RETRIEVAL=NOT_AUTHORIZED/NOT_EXECUTED; EXP12_REDESIGN_IN_CURRENT_EXPERIMENT=NOT_AUTHORIZED. NEXT_ELIGIBLE_BLOCK=GROUP3_METRICS_AND_INFERENCE; GROUP3=NOT_STARTED.** |
| 3. Métricas e inferencia | **NEXT / NOT_STARTED — GROUP3_METRICS_AND_INFERENCE** |
