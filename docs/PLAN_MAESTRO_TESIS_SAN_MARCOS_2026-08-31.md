...
Estado: `NOT_AUTHORIZED / NOT_EXECUTED`.
...
- `EXP12_PLANNING=NOT_YET_EXECUTED / NOT_YET_AUTHORIZED` y
...
EXP12 Pre-planning Correction v0.1 ✅ INTEGRATED
  ...
  ↓
EXP12 Planning Execution Gate ⏳ NEXT / NOT_YET_AUTHORIZED
  - planning not executed; D-HIGH/D-MID/D-LOW not selected
  ↓
