...
|---|---|---|---|---|---|---|---|
| Fig. 1 | figura de arquitectura | Contrato funcional completo: histórico fija ranking → normativa documenta sin reranking → LLM explica Top-3 inmutable, con prohibición de feedback | Methods | Hacer visible la separación causal/funcional que sostiene la contribución B | 0A-01; D-005; 0C freeze | `ESSENTIAL_NOW` | ninguna |
...
| B vs KBS expectations | MEDIUM | KBS espera investigación original/innovadora y puede considerar la arquitectura una integración | Formalizar interfaces/invariantes, evidenciar separación causal y función de cada evaluación; evitar novelty de componentes |
...
|---|---|---|---|---|---|---|---|
| Fig. 1 | architecture figure | Complete contract: historical ranking → non-reranking normative evidence → immutable-Top-3 explanation, with no feedback | Methods | Make causal/functional separation visible | 0A-01; D-005; frozen 0C | `ESSENTIAL_NOW` | none |
...
| B vs KBS expectations | MEDIUM | KBS expects original/innovative research | Formalize interfaces/invariants and function-specific evaluation |
