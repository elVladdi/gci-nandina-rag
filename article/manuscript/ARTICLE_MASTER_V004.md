...
Dataset provenance, partitioning, dependence, component-level
evaluation, reproducibility and public artifacts when relevant.

\[Section text to be drafted in a later approved version.\]

## 2.6. Positioning of this study

Short comparative synthesis. It may include a compact
literature-positioning table if the evidence base supports each
comparison. Do not convert absence within the reviewed scope into
universal novelty.
