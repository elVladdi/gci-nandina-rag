...
def main():
    ...
    # Match SVG physical size to the 300-dpi PNG: 120 drawing units per inch.
    ...
    def text(x,y,value,size=10,anchor="middle",bold=False,fill="#222222"):
        # 14.5 drawing units = 8.7 pt SVG / 8.64 pt raster after font rounding.
        size=max(size,14.5)
    ...
    text(35,26,"EXP11A joint size-composition sensitivity",17,"start",True)
    ...
    for idx,metric in enumerate(METRICS):
        ...
        anchors=[left+32+i*66 for i in range(5)]
        ...
        for ci,condition in enumerate(CONDITIONS):
            ...
            for offset,data in zip(offsets,grouped[condition]):
                ...
                marker(anchors[ci]+offset*160,y,condition=="H100 ref.",colors[condition])
