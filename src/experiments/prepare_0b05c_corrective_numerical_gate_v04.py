...
def validate_authorization_transition(
    ...
    require(baseline_gate.get("authorization_readiness") == "NOT_AUTHORIZED", "Authorization baseline readiness is invalid")
...
def _spec(root: Path, arm: str, revision: str) -> dict[str, Any]:
    ...
    replacements.update({
        ...
        "run_d1a_corrective_0b05c_v03": "run_d1a_corrective_0b05c_v04",
    ...
    result["specification_status"] = "PREEXECUTION_SPEC_DEFINED"
    ...
    if arm == "D1a":
        binding = git_binding(root, "src/experiments/run_d1a_corrective_0b05c_v04.py", revision)
