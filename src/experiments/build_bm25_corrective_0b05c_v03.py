"""Prospective BM25 builders for the isolated 0B-05C v0.3 gate."""
...
from .build_bm25_ev03_historical_recovered_v02 import TOKEN_POLICY, build_ev03_recovered_historical_from_corpus
from .prepare_0b05c_corrective_numerical_gate_v03 import require
...
def build(arm: str, corpus_path: Path, output_path: Path, metadata_path: Path, *, root: Path = ROOT) -> dict[str, Any]:
    ...
    metadata = {
        "artifact_id": f"0b05c_{arm.lower()}_corrective_bm25_index_v0.3",
        "arm": arm,
        ...
        "index_stats": stats,
        "identity_policy": "DERIVED_ONLY_AT_FUTURE_AUTHORIZED_V03_EXECUTION",
    }
